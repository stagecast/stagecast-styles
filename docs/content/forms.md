...
<div class="form-group">
  ...
  <div class="dropzone-control">
    <div class="dropzone-overlay d-none">
      <!-- add your loading image -->
    </div>
    <input type="file" id="immUploader1" name="image-upload" multiple accept="img/*">
    <label class="dropzone-control-label" for="immUploader1">
      <div class="text-primary">Drag and drop or click to upload a file</div>
      <div class="text-muted">You can add 2 files</div>
    </label>
    <!-- Divider -->
    ...
    <div class="dropzone-preview">
      <!-- image file type -->
      <div class="dropzone-preview-file">
      ...
      <div class="dropzone-preview-file">
        ...
        <a class="file-url text-white" href="https://external-content.duckduckgo.com/">https://external-content.duckduckgo.com/</a>
      </div>
    </div>
  </div>
